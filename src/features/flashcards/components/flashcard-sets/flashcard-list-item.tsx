  ...
  return (
    <div
      ...
      <div className="flex gap-2 w-full">
        <div className={clsx(card.definition && 'border-r-2 border-grey-4', 'w-1/3 pr-4 py-2')}>{card.term}</div>
      ...
      <div className="w-[6.75rem] flex">
        ...
        <Button isIconOnly aria-label="Play the card sound" radius="full" className="bg-transparent hover:bg-grey-3">
